...
Bitcoin SV is the original Bitcoin, so [awesome-bitcoin](https://github.com/igorbarinov/awesome-bitcoin) ⭐ 1,351 | 🐛 11 | 📅 2026-08-12 is referred.
...
* [`<qr-code>`](https://github.com/bitjson/qr-code) ⭐ 1,380 | 🐛 14 | 🌐 TypeScript | 📅 2023-02-28 – A no-framework, no-dependencies, customizable, animate-able, SVG-based `<qr-code>` HTML element.
...
* ECIES - Encrypt message with Bitcoin PublicKey, decrypt it with PrivateKey. BIE1 format, Electrum/Electron Cash Compatible. [JavaScript](https://github.com/monkeylord/electrum-ecies) ⭐ 9 | 🐛 1 | 🌐 JavaScript | 📅 2020-05-14/[Go](https://github.com/gitzhou/bitcoin-ecies) ⭐ 17 | 🐛 0 | 🌐 Go | 📅 2019-01-23
